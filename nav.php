             			...
             			<div class="modal-content">
             					<div class="modal-header">
             						      ...
             						      <div class="modal-body">
                                            						      			<div class="row">
             						      			<a href="/files/wallet/0.4.15/BitSharesX-0.4.15-a-x86.exe" class=" whoabtn">BitSharesX for Windows</a>
             						      			<a href="/files/wallet/0.4.15/BitSharesX-0.4.15.dmg" class="whoabtn" >BitSharesX for MAC</a>
