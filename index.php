            						  ...
            						  <h1 style="padding: 0;margin: 12px 0 2px 0;font-size: 36px;">Download BitSharesX</h1>  
            						    	...
            						    	<div class="modal-content">
            						      		...
            						      		<div class="modal-body">
                                           						      			<div class="row">
            						      			<a href="/files/wallet/0.4.5/BitSharesX-0.4.5.exe" class=" whoabtn" style="margin: 0 24px 12px 0;">BitsharesX for Windows</a>
            						      			<a href="/files/wallet/0.4.5/BitSharesX-0.4.5.dmg" class="whoabtn" >BitsharesX for MAC</a>
