 ...
 <body class="home" data-spy="scroll" data-target=".navbar" data-offset="53">
  ...
  <!-- Navigation Include -->
    ...
    <div style="margin-top: 32px;">
     ...
     <h6 class="animated fadeIn preserveHidden" style="margin-top: -32px;">Sicherer, vertraulicher und schneller Handel in Kryptomärkten. 
     </h6>
     <a href="about-de.php"   class=" animated fadeIn  btn whoabtn">Mehr erfahren</a>
        </div> </div><!-- end .row -->
