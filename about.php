                        			...
                        			<div class="modal-content">
                        					<div class="modal-header">
                        						      ...
                        						      <div class="modal-body">
                                                       						      			<div class="row">
                        						      			<a href="/files/wallet/0.4.6/BitSharesX-0.4.6.exe" class=" whoabtn" style="margin: 0 24px 12px 0;">BitSharesX for Windows</a>
                        						      			<a href="/files/wallet/0.4.6/BitSharesX-0.4.6.dmg" class="whoabtn" >BitSharesX for MAC</a>
				...
				<div class="row">
					...
					<div class="col-md-4 col-lg-4 aboutUsContent">
						...
						<p>
							...
							and bitassets. 	</p>
							<a href="/files/wallet/0.4.6/BitSharesX-0.4.6.exe" class="pull-left whoabtn btn" style="margin: 0 24px 12px 0;">BitsharesX for Windows</a>
							<a href="/files/wallet/0.4.6/BitSharesX-0.4.6.dmg" class="pull-left whoabtn btn" >BitsharesX for MAC</a>
