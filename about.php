                        			...
                        			<div class="modal-content">
                        					<div class="modal-header">
                        						      ...
                        						      <div class="modal-body">
                                                       						      			<div class="row">
                        						      			<a href="/files/wallet/0.4.7/BitSharesX-0.4.7.exe" class=" whoabtn" style="margin: 0 24px 12px 0;">BitSharesX for Windows</a>
                        						      			<a href="/files/wallet/0.4.7/BitSharesX-0.4.7.dmg" class="whoabtn" >BitSharesX for MAC</a>
			...
			<div id="wallet" class="container">
				<div class="row">
					...
					<div class="col-md-4 col-lg-4 aboutUsContent">
						<h2>Free markets. Free download.</h2>
						<p>
							...
							and bitassets. 	</p>
							<a href="/files/wallet/0.4.7/BitSharesX-0.4.7.exe" class="pull-left whoabtn btn" style="margin: 0 24px 12px 0;">BitsharesX for Windows</a>
							<a href="/files/wallet/0.4.7/BitSharesX-0.4.7.dmg" class="pull-left whoabtn btn" >BitsharesX for MAC</a>
		...
		<section id="intro" class="intro-small" style="background: #CCC;">
			...
			<div class="container">
				<div class="row introduction"><center>
					<h1 class="animated fadeInDown preserveHidden" style="text-transform: uppercase; font-size: 32px;">This isn’t your mother’s blockchain.</h1>					
					<h4 class="animated fadeIn preserveHidden">BitSharesX is about more than changing what’s possible with a blockchain. It’s about changing the rules of finance.</h4>
					</center>
				</div><!-- end .row -->
			</div><!-- end .container -->
	...
	<div class="container">
		...
		<div class="row features">
			...
			<h3><i class=" icon-layers"></i></h3>
				<h3>CUSTOMIZATION</h3>
				<p>
Create shares in your concept, business or idea and share them with a ready marketplace. BitSharesX supports both market-pegged assets (which track external prices) as well as user-issued assets.        </p>
			</div><!-- end .service -->
			<div class=" col-3 col-sm-4 col-lg-4 ">
			<h3><i class="icon-flash-outline"></i></h3>
        <h3>SPEED</h3>
				<p>
Transactions take place in seconds, not minutes or in the case of wire transfers hours or days.  Transfer worldwide at the speed of business. 
			</p>
			</div><!-- end .service -->
			<div class="col-3 col-sm-4 col-lg-4 ">
...
Financial tools are nothing without security.  BitSharesX operates as a peer-to-peer network without any single point of failure. It uses <a target="_blank" href="http://bitshares.org/intro-to-delegated-proof-of-stake/">Delegated Proof-of-Stake (DPOS)</a> for its blockchain security model.				</p>
			...
			<h3><i class=" icon-resize-small"></i></h3>
				<h3>DIRECT</h3>
				<p>
BitSharesX is peer to peer.  That means when you send or receive you are doing so directly with the person on the other end.  No middlemen to get in the way, no middlemen to take a cut.  Go direct. 
				</p>
			</div><!-- end .service -->
			<div class="col-3 col-sm-4 col-lg-4 ">
